document.addEventListener('DOMContentLoaded', () => {
    ...
    const MEGA_EVO_FAMILY_IDS = [
        1, 2, 3, 4, 5, 6, 7, 8, 9, 13, 14, 15, 16, 17, 18, 63, 64, 65, 79, 80,
        92, 93, 94, 95, 115, 123, 127, 129, 130, 142, 150, 179, 180, 181, 199,
        208, 212, 214, 228, 229, 246, 247, 248, 252, 253, 254, 255, 256, 257,
        258, 259, 260, 280, 281, 282, 302, 304, 305, 306, 307, 308, 309, 310,
        318, 319, 322, 323, 333, 334, 353, 354, 359, 361, 362, 371, 372, 373,
        374, 375, 376, 380, 381, 384, 427, 428, 443, 444, 445, 447, 448, 459,
        460, 475, 478, 531, 719, 900
    ].sort((a, b) => a - b);
    // --- 函式定義 ---
    ...
    megaButton.addEventListener('click', () => {
        const idsToFilter = MEGA_EVO_FAMILY_IDS;
